...
LORA_PATH = os.path.join(PROJECT_ROOT, "LLaMA-Factory/saves/qwen3vl-8b/lora/sft")
IS_LORA = True # set True if use Lora checkpoints

BASE_DIR = os.path.join(PROJECT_ROOT, "realdata_benchmark")

JSON_FILE = "pure_real_test.json"

OUTPUT_FILE = "real_testset_qwen3_8b_lora.json" if IS_LORA else "real_testset_qwen3_8b.json"
